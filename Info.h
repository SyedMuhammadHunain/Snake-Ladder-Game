...
char rollResultMessage[64] = ""; // To store rolling message
char specialMessage[64] = "";    // To store snake and ladder check message
float specialMessageTime = 0.0f; // Timer for message duration
